...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col pt-32 pb-20 px-4 relative overflow-hidden">
      {/* Decorative background */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-orange-500/5 blur-[120px] rounded-full translate-x-1/3 -translate-y-1/3 animate-float"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-orange-500/5 blur-[120px] rounded-full -translate-x-1/4 translate-y-1/4 animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
           ...
           <Card className="p-8 md:p-10 border-none shadow-2xl shadow-gray-200/50 rounded-[40px] bg-white relative overflow-hidden hover-lift transition-all duration-300">
              ...
              <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                       ...
                       <Input placeholder="John Doe" className="h-12 rounded-2xl bg-gray-50 border-transparent focus:bg-white" required />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-bold uppercase text-gray-400 tracking-widest ml-2">Email Address</label>
                       <Input type="email" placeholder="john@example.com" className="h-12 rounded-2xl bg-gray-50 border-transparent focus:bg-white" required />
                    </div>
                 </div>
                 <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase text-gray-400 tracking-widest ml-2">Reason for Contact</label>
                    <div className="relative">
                       <Input placeholder="Technical Support, Delivery Issue..." className="h-12 rounded-2xl bg-gray-50 border-transparent focus:bg-white" />
                 ...
                 <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full min-h-[120px] bg-gray-50 border-transparent focus:bg-white p-4 rounded-2xl text-sm font-medium outline-none transition-all focus:ring-2 focus:ring-orange-500/10" 
                      required
                    ></textarea>
                 </div>
                 <Button className="w-full h-12 rounded-2xl bg-orange-500 hover:bg-orange-600 font-bold shadow-xl shadow-orange-500/20 group hover-lift">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             ...
             <div key={i} className="p-8 rounded-[32px] bg-gray-50 border border-gray-100 group hover:bg-gray-950 hover:text-white transition-all duration-500 hover-lift">
